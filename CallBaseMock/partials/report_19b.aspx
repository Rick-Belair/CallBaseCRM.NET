<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report_19b.aspx.cs" Inherits="CallBaseMock.partials.report_19b" %>
...
<body>
    ...
    <h2 class="textCenter">
        <asp:Label ID="lblRepHeader" runat="server" Text=""></asp:Label></h2>
    <h3 class="textCenter">
        <asp:Label ID="lblReportTitle" runat="server" Text=""></asp:Label></h3>
    <br />
    <div class="floatLeft">
    <span class="reportText"><asp:Label ID="lblPrintedBy" runat="server" Text=""></asp:Label> </span>
    ...
    <div runat="server" id="hasRowsDiv">
        ...
        <table class="statusReportTable">
            ...
            <tr>
                <td>
                    <span class="reportText fontBold"><asp:Label ID="lblDoneTicketsText" runat="server" Text=""></asp:Label> </span>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <span class="reportText fontBold"><asp:Label ID="lblCompTimeText" runat="server" Text=""></asp:Label> </span>
                </td>
                <td>
        ...
        <asp:Table ID="tblReport" runat="server" CssClass="statusReportTable blackText">
            <asp:TableHeaderRow CssClass="fontBold">
                ...
                <asp:TableCell>Date to Call <br />
                Client Back</asp:TableCell><%--Need to create label--%>
