<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report_19a.aspx.cs" Inherits="CallBaseMock.partials.report_19a" %>
    ...
    <div runat="server" id="hasRowsDiv">
        ...
        <table class="statusReportTable">
            <tr>
                <td>
                    <span class="reportText fontBold">
                        <asp:Label ID="lblOpenTicketsText" runat="server" Text=""></asp:Label> </span>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <span class="reportText fontBold">
                        <asp:Label ID="lblDoneTicketsText" runat="server" Text=""></asp:Label> </span>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <span class="reportText fontBold">
                        <asp:Label ID="lblCompTimeText" runat="server" Text=""></asp:Label> </span>
                </td>
                <td>
                    <asp:Label ID="lblCompTime" runat="server" Text="" CssClass="reportText"></asp:Label>
                    <span class="reportText">
                        <asp:Label ID="lbl24Clock" runat="server" Text=""></asp:Label></span>
                </td>
            </tr>
        </table>
        <hr />
