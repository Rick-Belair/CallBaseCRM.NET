...
{
    public partial class report_19b : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            lblReportTitle.Text = langDB.GetLabel("RptR19", "R19bName", pageLang);
            lblReportNum.Text = langDB.GetLabel("RptR19a", "R19aRepRptNo", pageLang) + ": 19b";
